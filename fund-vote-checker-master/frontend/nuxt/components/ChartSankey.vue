      ...
      >
        ...
        <div id="sankey-chart-modals">
          ...
          <ChartSankeyModalStageLabel
            ...
            :fontSizeText="getFontSize(dataCurrentYear[stage.name], 'subline')"
      ...
      <div id="bar-and-line-chart-container" class="position-relative">
        ...
        >
          ...
          <div :style="`position: relative;`">
            ...
            >
              <div class="bar-chart--year center-absolute--vertical text-right">
                <div
                  class="caption"
                  :style="
              ...
              <div :class="`bar-chart--bar d-flex mb-${bar.marginBottom / 4}`">
                <div
        ...
        <div
          class="position-absolute-tl0"
          :style="`transform: translateX(${marginLeft + lineChartStart}px);`"
        >
        ...
        <div
          :class="
            `${
              breakpoint && breakpoint.smAndUp ? 'position-absolute-tl0' : ''
            } height-100pc`
          "
        ...
        >
          ...
          >
            <p
              :class="`${breakpoint && breakpoint.smAndUp ? 'mt-n12' : 'mt-8'}`"
            >
